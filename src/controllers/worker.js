...
router.get('/workers', allow.worker(), function (req, res, next) {
...
router.get('/workers/:id/edit', allow.worker(), function (req, res, next) {
...
router.put('/workers/:id', allow.worker(), function (req, res, next) {
  var id = req.params.id,
